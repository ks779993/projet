			...
			<div class="row justify-content-center">
				<div class="col-md-12 col-lg-10">
					<div class="wrap d-md-flex">
						<div class="text-wrap p-4 p-lg-5 text-center d-flex align-items-center order-md-last" style="background-color: blue;">
							<div class="text w-100">
								...
								<a href="register" class="btn btn-white btn-outline-white">S'inscrire</a>
							</div>
			      </div>
		            ...
		            <div class="form-group">
		            	<a href=""><button type="submit" class="form-control btn btn-primary submit px-3">Se connecter</button></a>
		            </div>
