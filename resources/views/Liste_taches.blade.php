          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="pages/forms/basic_elements.html">
                ...
                <span class="menu-title">listes des compagnies</span>
              </a>
            </li>
            <!-- <li class="nav-item">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="pages/samples/blank-page.html"> Accueil </a>
                  </li>
                 @auth
                 <li class="nav-item">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <!-- Page Title Header Ends-->
              ...
              <div class="col-md-12">
                <div class="row">
                  <div class="col-md-12 grid-margin" style="display: flex; justify-content:center">
                    <div class="card">
                      <div class="card-body">
                        <h1 class="card-title mb-4">Liste des compagnies</h1>
                        <div class="row">
                            ...
                            @foreach($compagnies as $compagnie)
                              <tr>
                                ...
                                <td> 
                                    ...
                                    <a href="" class="btn btn-danger" onclick="return confirm('etes-vous sur de vouloir supprimer cet utilisateur ?')" >Supprimer</a>
                                </td>
                              </tr>
                  ...
                  <div class="col-md-12 grid-margin" style="display: flex; justify-content:center">
                    <div class="card">
                      <div class="card-body">
                        <h4 class="card-title mb-0">liste des horaires disponible</h4>
                        <div class="row">
                        <div class="table-responsive">
                          <table class="table table-striped table-hover">
                            <thead>
