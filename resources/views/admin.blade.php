      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ route('traiterFormulaire') }}">
                <i class="menu-icon typcn typcn-th-large-outline"></i>
                <span class="menu-title">Enregistrer un Car</span>
              </a>
            </li>
                            ...
                            @foreach($reservations as $reservation)
                              <tr>
                                ...
                                <td> 
                                    ...
                                    <a href="" class="btn btn-danger" onclick="return confirm('etes-vous sur de vouloir supprimer cet utilisateur ?')" >Annuler</a>
                                </td>
                              </tr>
